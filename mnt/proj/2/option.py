...
parser.add_argument('--dataset_dir', type=str, default='/mnt/proj/final_network/CUFED/',
...
parser.add_argument('--lr_rate', type=float, default=1e-5,
                    help='Learning rate')
parser.add_argument('--lr_rate_dis', type=float, default=1e-6,
...
args.num_res_blocks = list(map(int,
args.num_res_blocks.split('+')))
#print(args.num_res_blocks)